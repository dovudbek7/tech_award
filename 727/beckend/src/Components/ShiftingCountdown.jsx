...
const CountdownItem = ({ unit, text }) => {
  ...
  return (
    <div className="chegirma-raqam flex h-8 w-[150px]  flex-col items-center justify-center  md:h-36">
      <div className="relative w-full overflow-hidden text-center">
        <span
          ref={ref}
          className="block  font-medium  text-[35px] "
        >
          {time}
        </span>
      </div>
      <span className=" font-light text-slate-500 md:text-sm lg:text-base">
        {text}
      </span>
    </div>
  );
