...
const data = [
    { id: 20, phone: '+912055043', status: 'Kutilayotgan', total: '180,000 uzs', date: '06.23.24', note: 'Izoh yo\'q', },
    { id: 20, phone: '+912055043', status: 'Kutilayotgan', total: '180,000 uzs', date: '06.23.24', note: 'Izoh yo\'q', },
    { id: 20, phone: '+912055043', status: 'Kutilayotgan', total: '180,000 uzs', date: '06.23.24', note: 'Izoh yo\'q', },
    { id: 20, phone: '+912055043', status: 'Kutilayotgan', total: '180,000 uzs', date: '06.23.24', note: 'Izoh yo\'q', },
    { id: 20, phone: '+912055043', status: 'Kutilayotgan', total: '180,000 uzs', date: '06.23.24', note: 'Izoh yo\'q', },
                            ...
                            <div className="grid grid-cols-8 gap-2">
                                ...
                                {data.map((item, index) => (
                                    <>
                                        ...
                                        <button className='bg-[#0066FF] text-white rounded p-[3px] text-[15px] font-[600]' onClick={handleAccapted}>Buyurtmani olish</button>
                                    </>
                                ))}
                            </div>
                        </div>
